<div class="content-2" id="content-2">
			<div class="container container-content-2" style="margin-top:30px;">
				<div class="row">
									...
									<div class="card card-format-border-left">
										<div class="card-body">
											<div class="row">
												...
												<div class="col-sm-7 col-money">
													<span><i class="fa fa-eur" aria-hidden="true"></i></span>
													<p class="card-text p-money">30.000.000đ/tháng</p>
												</div>
												<div class="col-sm-5 col-time">
													<span><img class="img-time" src="./Images/time.jpg" alt=""></span>
													<p class="card-text p-time">Toàn thời gian</p>
												</div>
												<div class="col-sm-12">
									...
									<div class="card card-format-border-left">
										<div class="card-body">
											<div class="row">
												...
												<div class="col-sm-7 col-money">
													<span><i class="fa fa-eur" aria-hidden="true"></i></span>
													<p class="card-text p-money">23.000đ/giờ</p>
												</div>
												<div class="col-sm-5 col-time">
													<span><img class="img-time" src="./Images/time.jpg" alt=""></span>
													<p class="card-text p-time">Bán thời gian</p>
												</div>
												<div class="col-sm-12">
									...
									<div class="card card-format-border-left">
										<div class="card-body">
											<div class="row">
												...
												<div class="col-sm-7 col-money">
													<span><i class="fa fa-eur" aria-hidden="true"></i></span>
													<p class="card-text p-money">22.000.000đ/tháng</p>
												</div>
												<div class="col-sm-5 col-time">
													<span><img class="img-time" src="./Images/time.jpg" alt=""></span>
													<p class="card-text p-time">Toàn thời gian</p>
					...
					<div class="d-none d-md-block col-md-5 col-lg-6 col-xl-7 col-content2-right">
						<div class="row">
