				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarNavDropdown">
						...
						<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
							...
							<span>
								<img class="format-img-user" src="../../assets/Images/google.png" alt="google"></span>
							<div class="navbar-img-notice">
								<span>
									<img class="format-img-notice" src="../../assets/Images/ic_notifications_none_24px.png" alt="">
								</span>
							</div>
										...
										<div class="card-body">
											<div class="row">
												<div class="col-sm-12 col-img-text">
													<div class="col-img">
														<span>
															<img class="format-img-userxinviec" src="../../assets/Images/dummy_team_member.png" al=""></img>
														</span>
													</div>
													<div class="col-text">
												...
												<div class="col-sm-12 col-time">
													<span><img class="img-time" src="../../assets/Images/time.jpg" alt=""></span>
									...
									<div class="body">
										<div class="row">
											<div class="col-sm-12 img-userxinviec-right">
												<span><img class="format-img-userxinviec-right" src="../../assets/Images/18-F.png" alt=""></span>
											</div>
											<div class="col-sm-12">
									...
									<div class="body">
										<div class="row">
											...
											<div class="col-sm-12  mgl-col-content2-right-below format-mt-item">
												<span class="format-span-img-cake"><img class="format-img-cake" src="../../assets/Images/ic_cake_24px.png" alt="">1/1/2000</span>
												<span class="format-span-img-gender"><img class="format-img-gender" src="../../assets/Images/ic_wc_24px.png" alt="">Nữ</span>
											</div>

											<div class="col-sm-12  mgl-col-content2-right-below format-mt-item">
												<span class="format-span-img-call"><img class="format-img-call" src="../../assets/Images/ic_call_24px.png" alt="">0987654321</span>
												<span class="format-span-img-letter"><img class="format-img-letter" src="../../assets/Images/ic_markunread_24px.png" alt="">William@gmail.com</span>
											</div>

											<div class="col-sm-12  mgl-col-content2-right-below format-mt-item">
												<span><img class="format-img-place" src="../../assets/Images/ic_place_24px.png" alt="">19 Đ. Nguyễn Hữu Thọ, Tân Hưng, Quận 7, Thành phố Hồ Chí Minh</span>
											</div>
