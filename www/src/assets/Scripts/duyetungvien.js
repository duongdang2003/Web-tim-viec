        ...
        if (data[i]["daduyet"]==-1){
            ...
            <td class="format-td">
                <div class="format-td-hoso">
                    <a class="format-hoso" role="button" href="../../../src/Views/user/pageinfouser.php?id=${data[i]["ID_user"]}" class="btn btn-link  btn-rounded">
                        Xem hồ sơ
                    </a>
                </div>
                <div class="format-td-baidang">
                    <a class="format-baidang" class="aa" role="button" href="../../../src/Views/admin/pageinfoadmin.php?idbaidang=${data[i]["ID_BaiDang"]}" class="btn btn-link btn-rounded">
                        Xem bài đăng
                    </a>
                </div>
            ...
            <td>
                <div class="format-btn-dongy">
                    <button onclick="dongyduyet(${data[i]["ID_user"]})" class="btn-dongy" aria-haspopup="true" aria-expanded="false">
                        <span>
                ...
                <div class="format-btn-tuchoi" id="format-btn-tuchoi-id">
                    <button onclick="tuchoiduyet(${data[i]["ID_user"]})" class="btn-tuchoi" id="btn-tuchoi-id" aria-haspopup="true" aria-expanded="false">
                        <span>
            ...
            <td class="format-td">
                ...
                <div class="format-td-baidang">
                    <a class="format-baidang" role="button" href="../../../src/Views/admin/pageinfoadmin.php?idbaidang=${data[i]["ID_BaiDang"]}" class="btn btn-link  btn-rounded">
                        Xem bài đăng
                    </a>
                </div>
            </td>
