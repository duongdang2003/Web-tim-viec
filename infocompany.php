...
<head>
    ...
    <link rel="stylesheet" href="./Style/infocompany.css">
        ...
        <div id="content">
            <div class="container">
                    <div class="format-col-info">
                        <div class="col-img">
                            <span><img class="format-img-company" src="./Images/google.png" alt=""></span>
                        </div>
                        <h4 class="format-nameComapy">Google</h4>
                    </div>
                    
                    <div class="format-col-option">
                        <a class="format-text" href="">Việc làm</a>
                        <a class="format-text" href="">Giới thiệu công ty</a>
                        <a class="format-text" href="">Ảnh</a>
                        <a class="format-text" href="">Phúc lợi</a>
                        <a class="format-text" href="">Chỉnh sửa thông tin</a>
                    </div>
                    <hr>
