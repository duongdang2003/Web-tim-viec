...
drop table if exists TimViec;
drop table if exists GoiyVieclam;
drop table if exists BaiTimViec;
drop table if exists NguoiTimViec;
drop table if exists in4NTD;
drop table if exists BaiTuyenDung;
